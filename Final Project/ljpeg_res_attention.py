# -*- coding: utf-8 -*-
"""ljpeg_res_attention.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1PffoMbCpT6lrNmAhiH_GTA8x2ESk3vMY
"""
...
class JPEGAutoEncoder(tf.keras.layers.Layer):
    ...
    def build(self, input_shape):
        ...
        self.res_attention = ResNetAttention() #ResNet attention network
    ...
    def call(self, tensor):
        ...
        tensor, attention = self.res_attention(tensor, input_image) #apply attention based smoothing
...
def train(args):
    ...
    #train_msssim = tf.reduce_mean(tf.image.ssim_multiscale(x, x_tilde, 255, filter_size=4))
    # Perceptual loss
